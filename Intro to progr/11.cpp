...
main ()
{
    ...
    if (b < c)
    {
        cout << "Точка В расположена ближе к точке А, чем точка С. Расстояние от точки В до точки А равно " << b << endl;
    }
    else if (c < b)
    {
        cout << "Точка C расположена ближе к точке А, чем точка B. Расстояние от точки В до точки А равно " << c << endl;
    }
    else
    {
